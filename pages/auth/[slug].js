...
import AuthBg from "@/public/img/auth-bg.svg";
import authImg from "@/public/img/auth-img.png";
...
export default function auth() {
  ...
  return (
    ...
    <main className="relative flex grow h-[100vh]">
      <div
        ...
        <div className="flex h-full flex-col justify-center before:min-h-[4rem] before:flex-1 after:flex-1 md:before:min-h-[5rem]">
          <div className="px-4 sm:px-6">
            <div className="mx-auto w-full max-w-sm">
              <div className="py-16 md:py-20">{renderComponent()}</div>
            </div>
          </div>
        </div>
      </div>
